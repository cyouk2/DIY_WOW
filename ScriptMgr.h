...
class TC_GAME_API ItemScript : public ScriptObject
{
    ...
    public:
        ...
        // cyouk2
        virtual bool OnGossipSelect(Player* /*player*/, Item* /*item*/, uint32 /*sender*/, uint32 /*action*/, SpellCastTargets const& /*targets*/) { return false; };
...
class TC_GAME_API ScriptMgr
{
    ...
    public: /* ItemScript */
        ...
        // cyouk2
        bool OnGossipSelectItem(Player* player, Item* item, uint32 sender, uint32 action, SpellCastTargets const& targets);
